...
# 👨‍⚕️ "Rajeev Store" - Auto-Lead Capture Agent
...
print("\n" + "💼" * 50)
print("🚀 AI SDR AGENT - BY RAJEEV")
print("📚 SELLING: Rajeev's Cloud & AI Courses")
...
# Default FAQ data for "Rajeev Store"
DEFAULT_FAQ = [
    {
    ...
    },
    {
        ...
        "answer": "Yes! Rajeev releases weekly tutorials on YouTube for free. The paid courses offer deep-dives, code reviews, and certification."
    },
    {
...
class SDRAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions=f"""
            You are 'Sarah', a friendly and professional Sales Development Rep (SDR) for 'Rajeev Store'.
            ...
            🚫 **RESTRICTIONS:**
            - If you don't know an answer, say "I'll check with Rajeev and email you." (Don't hallucinate prices).
            """,
